...
func (app *MyApp) InitChain(ctx context.Context, req *abci_types.InitChainRequest) (*abci_types.InitChainResponse, error) {
	...
	if len(app.ledger) == 0 {
		...
		app.ledger["serf1"] = 100000
		app.ledger["serf2"] = 100000
		app.ledger["serf3"] = 100000
		app.ledger["serf4"] = 100000
		app.ledger["serf5"] = 100000
		app.ledger["serf6"] = 100000
		app.ledger["serf7"] = 100000
		app.ledger["serf8"] = 100000
		app.ledger["serf9"] = 100000
		app.ledger["serf10"] = 100000
...
func main() {
	log.Println("--- [VERSION 1.0 - ABCI with Persistance ---")
