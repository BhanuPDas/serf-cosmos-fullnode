...
func DefaultP2PConfig() *P2PConfig {
                return &P2PConfig{
		RootDir:                os.ExpandEnv("$HOME/.cometbft"),
		ListenAddress:          "tcp://0.0.0.0:26656",
		ExternalAddress:        "", // Example default, check actual default in your version
		Seeds:                  "",
		PersistentPeers:        "",
		AddrBook:               "addrbook.json", // Example
		AddrBookStrict:         true,
		MaxNumInboundPeers:     40, // Example
		MaxNumOutboundPeers:    10, // Example
		UnconditionalPeerIDs:   "",
		PersistentPeersMaxDialPeriod: 0 * time.Second, // Example
		FlushThrottleTimeout:   100 * time.Millisecond, // Example
		MaxPacketMsgPayloadSize: 1024, // Example
		SendRate:               5000000, // 5MBytes/s (example)
		RecvRate:               5000000, // 5MBytes/s (example)

		// Set default values for the new fields
		PexReactor:     true, // Default to true, you'll set to false in config.toml
		SerfRPCAddress: "127.0.0.1:8080", // Default gRPC address for the Serf daemon
	}
}
